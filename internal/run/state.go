// Package run manages persistence of workflow run state and context to disk.
package run
...
// RunState holds the persistent state of a workflow run.
...
// StateStore persists and retrieves workflow run state.
