...
func TestNewProviderForModel_Claude(t *testing.T) {
	provider, err := agent.NewProviderForModel("claude-sonnet-4-6", "", "ant-key", "")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if _, ok := provider.(*agent.AnthropicProvider); !ok {
		t.Errorf("expected AnthropicProvider, got %T", provider)
	}
}

func TestNewProviderForModel_GPT(t *testing.T) {
	provider, err := agent.NewProviderForModel("gpt-4o", "", "", "oai-key")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if _, ok := provider.(*agent.OpenAIProvider); !ok {
		t.Errorf("expected OpenAIProvider, got %T", provider)
	}
}

func TestNewProviderForModel_O1(t *testing.T) {
	provider, err := agent.NewProviderForModel("o1-preview", "", "", "oai-key")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if _, ok := provider.(*agent.OpenAIProvider); !ok {
...
func TestNewProviderForModel_O3(t *testing.T) {
	provider, err := agent.NewProviderForModel("o3-mini", "", "", "oai-key")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if _, ok := provider.(*agent.OpenAIProvider); !ok {
...
func TestNewProviderForModel_Unknown(t *testing.T) {
	_, err := agent.NewProviderForModel("llama-3", "", "", "")
	if err == nil {
...
func TestNewProviderForModel_UnknownWithProvider(t *testing.T) {
	provider, err := agent.NewProviderForModel("my-fine-tuned", "openai", "", "oai-key")
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if _, ok := provider.(*agent.OpenAIProvider); !ok {
...
func TestNewProviderForModel_MissingAnthropicKey(t *testing.T) {
	_, err := agent.NewProviderForModel("claude-sonnet-4-6", "", "", "")
	if err == nil {
...
func TestNewProviderForModel_MissingOpenAIKey(t *testing.T) {
	_, err := agent.NewProviderForModel("gpt-4o", "", "", "")
	if err == nil {
