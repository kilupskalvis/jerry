...
func (a *Agent) Run(ctx context.Context, input string) (string, error) {
	...
	for turn := range a.maxTurns {
		...
		resp, err := a.provider.Complete(ctx, CompleteParams{
			Model:        a.model,
...
func (a *Agent) buildToolMap() map[string]Tool {
...
func (a *Agent) executeTools(ctx context.Context, calls []ToolCall, toolMap map[string]Tool) []ToolResult {
